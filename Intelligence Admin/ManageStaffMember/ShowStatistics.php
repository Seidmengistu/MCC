                            ...
                            <div class="content">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-6">
                                            <div style="align:center" class="small-box bg-info">
                                                <div class="inner">
                                                    ...
                                                    $query=$dbh->prepare("SELECT id From admin WHERE status=1 && Role='iuser'  ORDER BY id");
                                                    $query->execute();
                                                    $row=$query->rowCount();
                                                    echo '<h1>'.$row.'</h1>';
                                        ...
                                        $query=$dbh->prepare("SELECT id From admin WHERE status=0 && Role='iuser' ORDER BY id");
                                         $query->execute();
                                        $row=$query->rowCount();
                                        echo '<h1>'.$row.'</h1>';
