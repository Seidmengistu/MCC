...
// die();
$sql="INSERT INTO  message(fromm,too,reason,importer,importer_tin,agent,agent_tin,risk_level,section,declaration_no,
                           goods_description,info_sender_officer,code,esignature,edate,etime,approved_by,reasons_for_goods_examined,status)

                   VALUES(:from,:to,:reason,:importer,:importertin,:agent,:agenttin,:risklevel,:section,:declarationnumber,
